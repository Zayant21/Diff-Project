...
para* para_make(char* base[], int filesize, int start, int stop) {                                                     // Func to make a new paragraph
...
para* para_first(char* base[], int size) {  // func to mark the begining of paragraph
...
void loadfiles(const char* filename1, const char* filename2) {
  ...
  FILE* fin3 = openfile(filename1, "r");  // only to compare files cause they were being changed
